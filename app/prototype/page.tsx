...
export default function page() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-[#14DBD8]/20">
      <section className="relative px-4 py-20 lg:py-32">
        <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/10 to-purple-500/10 blur-3xl" />
        <div className="relative mx-auto max-w-6xl text-center">
          <Badge className="mb-6 border-cyan-500/30 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 text-cyan-300">
            🚀 Prototype Project
          </Badge>
          <h1 className="mb-6 bg-gradient-to-r from-white via-cyan-200 to-purple-300 bg-clip-text text-5xl font-bold leading-tight text-transparent lg:text-7xl">
          ...
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            <Link
              ...
              target="_blank"
              className="flex h-11 items-center justify-center rounded-md bg-gradient-to-r from-cyan-500 to-[#14DBD8]/20 px-8 py-3 text-lg text-white hover:from-cyan-600 hover:to-[#14DBD8]/20"
            >
              Join the Movement
      ...
      <section
        id="features"
        className="bg-black/20 px-4 py-20 backdrop-blur-sm"
      >
        <div className="mx-auto max-w-6xl">
          <div className="mb-16 text-center">
            <h2 className="mb-4 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-4xl font-bold text-transparent">
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col items-center justify-center space-y-4">
            <Link
              ...
              className="flex h-12 w-[350px] items-center justify-center rounded-md bg-gradient-to-r from-cyan-500 to-[#14DBD8]/20 px-8 py-4 text-xl text-white hover:from-cyan-600 hover:to-[#14DBD8]/20"
            >
              Start Your Journey
