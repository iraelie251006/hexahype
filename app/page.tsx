...
<div className="w-full h-screen relative">
  ...
  <div className="absolute inset-0 z-10 flex items-center justify-center">
    <div className="flex justify-between items-center w-full h-screen">
      <div>
      {/* <h1 className="text-white text-4xl font-bold">Hexahype</h1> */}
    <ShinyText text="Hexahype" disabled={false} speed={1} className='font-bold text-9xl flex justify-start ml-10' />
    </div>
